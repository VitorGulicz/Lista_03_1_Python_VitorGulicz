...
# de 45% quando o preço de custo é menor ou igual a 100 reais se o produto custa mais que isso a margem bruta e de 25%	
...
if preco<=100:
    ...
    print("Preço do produto com margem bruta de 25% R$: {} - Vitor Gulicz".format(precoMargem))